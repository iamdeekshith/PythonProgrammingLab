...
#Accessing Lists With Step Size
'''
my_list = [num for num in range (1,6)]
print(my_list)
...
#Adding to Lists with step size 
'''
...
#Modifying Lists with step size
'''
...
#Deleting from Lists with step size
'''
...
#List Comprehension with syep size
'''
numbers = [1, 2, 3, 4, 5]
...
additional_modules = ["Matplotlib", "scikit-learn"programming_languages = ["C", "Java", "Python", "Ruby"]
